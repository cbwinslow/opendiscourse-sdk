...
-- GovInfo unified schema for API and bulk data ingestion
-- This migration creates the full relational model for legislative, membership,
-- voting, publication, and download metadata derived from https://api.govinfo.gov
-- and https://www.govinfo.gov/bulkdata resources.
