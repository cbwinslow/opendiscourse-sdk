...
Description:
    Robust error handling system specifically for GovInfo CLI.
...
Classes:
    - GovInfoError: Base exception for GovInfo CLI
    - APIError: API-related errors
    - DatabaseError: Database-related errors
    - DataQualityError: Data validation errors
    - GovInfoErrorHandler: Centralized error handling

Usage:
    from scripts.ingestion.govinfo_error_handler import GovInfoErrorHandler

    handler = GovInfoErrorHandler()
...
class ErrorCategory(str, Enum):
    """Error categories for GovInfo CLI."""
    API_ERROR = "api_error"
...
class GovInfoError(Exception):
    """Base exception for GovInfo CLI errors."""
...
class DatabaseError(GovInfoError):
...
class DataQualityError(GovInfoError):
...
class RateLimitError(GovInfoError):
...
class DuplicateRecordError(GovInfoError):
...
class GovInfoErrorHandler:
    """
    Centralized error handling for GovInfo CLI.
    ...
    def __init__(self, log_file: Optional[Path] = None):
        ...
        """
        # Setup logging
        self.logger = logging.getLogger("GovInfoErrorHandler")
        ...
        self.logger.info("GovInfo error handler initialized")
    ...
    def handle_error(
        ...
        Args:
            ...
            context: Additional context (bill_id, govinfo, etc.)
    ...
    def _categorize_error(self, error: Exception) -> ErrorCategory:
        ...
        Returns:
            ErrorCategory
        """
        if isinstance(error, GovInfoError):
