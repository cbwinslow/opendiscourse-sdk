"""
================================================================================
File: openstates_error_handler.py
...
Description:
    Robust error handling system specifically for OpenStates CLI.
...
Classes:
    - OpenStatesError: Base exception for OpenStates CLI
    - APIError: API-related errors
    - DatabaseError: Database-related errors
    - DataQualityError: Data validation errors
    - OpenStatesErrorHandler: Centralized error handling

Usage:
    from scripts.ingestion.openstates_error_handler import OpenStatesErrorHandler

    handler = OpenStatesErrorHandler()
...
class ErrorCategory(str, Enum):
    """Error categories for OpenStates CLI."""
    API_ERROR = "api_error"
...
class OpenStatesError(Exception):
    """Base exception for OpenStates CLI errors."""
...
class APIError(OpenStatesError):
    """API-related errors."""
...
class DatabaseError(OpenStatesError):
...
class DataQualityError(OpenStatesError):
...
class DuplicateRecordError(OpenStatesError):
...
class OpenStatesErrorHandler:
    """
    Centralized error handling for OpenStates CLI.
    ...
    def __init__(self, log_file: Optional[Path] = None):
        ...
        """
        # Setup logging
        self.logger = logging.getLogger("OpenStatesErrorHandler")
        ...
        self.logger.info("OpenStates error handler initialized")
    ...
    def handle_error(
        ...
        Args:
            ...
            context: Additional context (bill_id, openstates, etc.)
    ...
    def _categorize_error(self, error: Exception) -> ErrorCategory:
        ...
        Returns:
            ErrorCategory
        """
        if isinstance(error, OpenStatesError):
